...
public class BusinessDTOMapper {
    ...
    public BusinessForOffersPageDTO mapBusinessForOffersPageDTO(BusinessEntity business){
        return this.modelMapper.map(business, BusinessForOffersPageDTO.class);
    }
}
